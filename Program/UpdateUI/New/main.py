...
from calculateprogram.code_python import FirstDev,SecondDev,snv,msc 
...
##                            result = result*(snv_data.transpose())
                    ...
                    print("cal result1  : %.2f" % realresult, "+ Bias :", self.systemconfig.spinBox_4.value(), " = ", result1)
                    # result1 = result[0][0]
                ...
                if(file_2 != ""):
                    ...
                    print("cal result2  : %.2f" % realresult, " + Bias :", self.systemconfig.spinBox_5.value(), " = ", result2)
                    # result2 = result[0][0]
                ...
                if(file_3 != ""):
                    ...
                    result3 = sum(result) + int(self.systemconfig.spinBox_6.value())
                ...
                if(file_4 != ""):
                    ...
                    result4 = sum(result) + int(self.systemconfig.spinBox_7.value())
                ...
                if(file_5 != ""):
                    ...
                    result5 = sum(result) + int(self.systemconfig.spinBox_8.value())
